...
function searchCatalog() {
  return (
    <>
    <Container maxW={'80%'}>
      <Heading fontSize={{base:'16px',sm:'20px',md:'22px',lg:'32px'}} my={'2%'}>Каталоги оригинальных запчастей</Heading>
    <Box gap={'15%'} px={'5%'} py={'5%'} display={{base:'inline-block', lg:'flex'}}  width={'100%'} height={'auto'} my={'1%'} bg={'#fff'} boxShadow={'0px 0px 25px 5px #f2f2f2'}>
      <Box w={'100%'}>
